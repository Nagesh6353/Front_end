...
function TestiMonials() {
    return (
        <div>
            ...
            <main className="main">
                {/* Page Title */}
                    <PageTitle name="TestiMonials" title="TestiMonials" />
                {/* End Page Title */}
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <div className="profile">
                                            ...
                                            <div className="info">
                                                <h4>Marcus Chen <i className="bi bi-patch-check-fill" /></h4>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <div className="profile">
                                            ...
                                            <div className="info">
                                                <h4>Sarah Mitchell <i className="bi bi-patch-check-fill" /></h4>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <div className="profile">
                                            ...
                                            <div className="info">
                                                <h4>James Wilson <i className="bi bi-patch-check-fill" /></h4>
                                                <span>@jwilson</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <div className="profile">
                                            ...
                                            <div className="info">
                                                <h4>Emma Rodriguez <i className="bi bi-patch-check-fill" /></h4>
                                                <span>@emmarod</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <div className="profile">
                                            ...
                                            <div className="info">
                                                <h4>David Kumar <i className="bi bi-patch-check-fill" /></h4>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        ...
                                        <div className="profile">
                                            ...
                                            <div className="info">
                                                <h4>Sophia Lee <i className="bi bi-patch-check-fill" /></h4>
                                                <span>@sophialee</span>
                                            </div>
                                        </div>
                                    </div>
